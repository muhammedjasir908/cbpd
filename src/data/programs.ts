...
const rawData = [
  ...
  { title: "Construction Programmes", slug: "construction", icon: "🏗️", image: "/images/programs/construction.png", subs: ["Construction Project Management", "Health & Safety in Construction", "Quantity Surveying", "BIM Awareness", "Civil Engineering Site Practices"] },
  ...
  { title: "Fire & Safety Programmes", slug: "fire-safety", icon: "🧯", image: "/images/programs/fire-safety.png", subs: ["Fire Safety Management", "Risk Assessment", "Fire Prevention Systems", "Emergency Planning", "Fire Safety Engineering"] },
  ...
  { title: "Marine Programmes", slug: "marine", icon: "⚓", image: "/images/programs/marine.png", subs: ["Maritime Operations", "Marine Engineering", "Port & Harbour Management", "Maritime Safety & Survival", "Maritime Logistics"] },
  ...
  { title: "Transport Programmes", slug: "transport-logistics", icon: "🚛", image: "/images/programs/transport.png", subs: ["Transport Management", "Airline Management", "Aviation Management", "Logistics & Supply Chain", "Road Transport & Fleet"] },
  ...
  { title: "Security Programmes", slug: "security", icon: "🛡️", image: "/images/programs/security.png", subs: ["Security Management", "Asset Protection", "Risk Assessment", "Cybersecurity", "Close Protection"] },
];

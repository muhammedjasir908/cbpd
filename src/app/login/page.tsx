          ...
          <div className="md:w-5/12 bg-primary-900 relative hidden md:flex flex-col justify-between p-12 overflow-hidden border-r border-slate-200 dark:border-white/10">
            ...
            <div className="relative z-10 mt-20">
              <h2 className="text-3xl font-bold text-white mb-4 leading-tight">
                Redefine Your Professional <span className="text-accent-gold">Journey</span>
              </h2>
              ...
              <div className="flex items-center gap-3 text-sm text-accent-gold bg-accent-gold/10 px-4 py-2 rounded-full w-fit border border-accent-gold/20 shadow-inner">

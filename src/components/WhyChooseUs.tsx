...
export default function WhyChooseUs() {
  ...
  return (
    <section ref={sectionRef} className="py-24 bg-slate-100 dark:bg-[#050812] relative overflow-hidden">
      {/* Background Decor */}
          ...
          {reasons.map((reason, index) => (
            <TiltCard key={index} sensitivity={15} className="h-full group">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-4 group-hover:text-brand-blue dark:group-hover:text-amber-500 transition-colors">
                  {reason.title}
                </h3>
